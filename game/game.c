...
internal vec3_t camera_position = { 0, 0, -100 };
internal vec3_t mesh_rotation = { 0, 0, 0 };
internal float fov_factor = 250;
internal triangle_t *triangles_to_render = NULL;
...
game_update_and_render( game_memory_t *game_memory, game_color_buffer_t *buffer )
{
    ...
    if( !game_memory->is_initialized )
    {
        ...
        load_cube_mesh_data(state->mesh);
